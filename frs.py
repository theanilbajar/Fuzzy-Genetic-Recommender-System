...
import fuzzy_sets
import gim
from genetic import cost_function
...
def get_neighbours(model_active_users, model_passive_users):
    ...
    for _, value in model_active_users.iterrows():
        ...
        user_neighbours[value[-1]] = [n[1] for n in sorted(fuzzy_vec, key=operator.itemgetter(0), reverse=True)][
                                     :NO_OF_NEIGHBOURS]
